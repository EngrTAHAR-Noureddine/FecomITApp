...
class BodyUpdateFunction extends StatefulWidget {
  File file;
  BodyUpdateFunction({this.file});
  @override
  _BodyUpdateFunctionState createState() => _BodyUpdateFunctionState();
}

class _BodyUpdateFunctionState extends State<BodyUpdateFunction> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future:Services().Update(_myfile),
          ...
          if(check== true){
            ...
            Column(
              ...
              children: [
                ...
                Text("Mettre à jours (il ne fault pas de sortir)...")
              ],
            ),
            );
          }
